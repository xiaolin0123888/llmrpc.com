    ...
    <div style={{ maxWidth: 800, margin: '0 auto', padding: '6rem 2rem 3rem' }}>
      ...
      <div style={{ color: 'var(--text-gray)', lineHeight: 1.8, fontSize: '0.95rem' }}>
        ...
        <p style={{ marginBottom: '1.5rem' }}>
          By accessing or using LLMRpc (&ldquo;the Service&rdquo;), you agree to be bound by these
          Terms of Service.
        </p>
        ...
        <p style={{ marginBottom: '1.5rem' }}>
          LLMRpc provides access to AI model inference services via API. We do not guarantee
        ...
        <p style={{ marginBottom: '1.5rem' }}>
          All fees are listed on our pricing page. Payments are non-refundable unless otherwise
        ...
        <p style={{ marginBottom: '1.5rem' }}>
          LLMRpc shall not be liable for any indirect, incidental, or consequential damages arising
        ...
        <p>
          For questions about these Terms, please contact us at support@llmrpc.com
        </p>
      </div>
    </div>
  )
