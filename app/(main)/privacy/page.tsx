    ...
    <div style={{ maxWidth: 800, margin: '0 auto', padding: '6rem 2rem 3rem' }}>
      ...
      <div style={{ color: 'var(--text-gray)', lineHeight: 1.8, fontSize: '0.95rem' }}>
        ...
        <p style={{ marginBottom: '1.5rem' }}>
          LLMRpc (&ldquo;we&rdquo;, &ldquo;us&rdquo;, or &ldquo;our&rdquo;) operates the website
          llmrpc.com (the &ldquo;Service&rdquo;). This page informs you of our policies regarding the
        ...
        <ul style={{ marginBottom: '1.5rem', paddingLeft: '1.5rem' }}>
          ...
          <li>
            Payment information: processed securely via third-party payment providers; we do not
        ...
        <p style={{ marginBottom: '1.5rem' }}>
          We use your data to provide and maintain the Service, process payments, send
          service-related notifications, and improve our platform performance.
        </p>
        ...
        <p style={{ marginBottom: '1.5rem' }}>
          We take reasonable security measures to protect your personal data. However, no method of
        ...
        <p style={{ marginBottom: '1.5rem' }}>
          Our Service may contain links to third-party sites. We have no control over their privacy
          policies.
        </p>
