  ...
  return (
    <div style={{ width: '100%', maxWidth: '420px' }}>
      <div style={{ textAlign: 'center', marginBottom: '2.5rem' }}>
        ...
        <h1 style={{ fontSize: '1.6rem', fontWeight: 600, color: 'var(--text-dark)', marginTop: '1.5rem', marginBottom: '0.5rem' }}>Welcome back</h1>
        <p style={{ color: 'var(--text-gray)', fontSize: '0.92rem' }}>Sign in to your account to continue</p>
      </div>
      ...
      <div className="card" style={{ padding: '2.2rem' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.8rem' }}>
          <label style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', fontSize: '0.88rem', color: 'var(--text-gray)', cursor: 'pointer' }}>
            <input type="checkbox" /> Remember me
          </label>
          <a href="#" style={{ fontSize: '0.88rem', color: 'var(--primary)' }}>Forgot password?</a>
        </div>
